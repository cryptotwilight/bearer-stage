      ...
      <Container fluid>
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Total Investment</p>
                      <Card.Title as="h4">USDC 15,000.00</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Average Emissions(p/m)</p>
                      <Card.Title as="h4">8.4%</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Coupons Held</p>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Redemption Residual</p>
                      <Card.Title as="h4">USDC $2,500.00</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
        ...
        <Row>
          ...
          <Card className="strpied-tabled-with-hover">
              <Card.Header>
                <Card.Title as="h4">Available Pools</Card.Title>
                ...
                <Table className="table-hover table-striped">
                  <thead>
                    <tr>
                      ...
                      <th className="border-0">Utilisation</th>
                      <th className="border-0">Max Pool Capacity</th>
          ...
          <Card>
              <Card.Header>
                <Card.Title as="h4">Join Pool</Card.Title>
              </Card.Header>
              <Card.Body>
                <Form>
                  <Row>
